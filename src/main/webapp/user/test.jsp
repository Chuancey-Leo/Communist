...
<head>
    ...
    <link href="${pageContext.request.contextPath}/static/css/sitelogo.css" rel="stylesheet">
    <script src="${pageContext.request.contextPath}/static/js/cropper.min.js"></script>
    <script src="${pageContext.request.contextPath}/static/js/sitelogo.js"></script>
    ...
    <div class="row">
        <div id="crop-avatar" class="col-md-6">
            <div class="avatar-view" title="Change Logo Picture">
                <img src="${pageContext.request.contextPath}/static/img/logo.jpg" alt="Logo">
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="avatar-modal" aria-hidden="true" aria-labelledby="avatar-modal-label" role="dialog"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form class="avatar-form" action="${pageContext.request.contextPath}/user/setAvatar" enctype="multipart/form-data"
                  method="post">
